#!/usr/bin/env python3
"""
MetrologyAI SIH 2026 Presentation
Base: SIH2026-IDEA-Presentation-Format.pptx (template)
Content: MetrologyAI PS26034
Team: 57893, Zillion MindsSashakt
"""
...
OUTPUT = "MetrologyAI_SIH_2026_Zillion_MindsSashakt.pptx"
...
# Set new text with MAITRI team info
new_lines = [
    ...
    "Team ID – 57893",
    "Team Name – Zillion MindsSashakt (Registered on portal)"
]
...
for i, slide in enumerate(prs2.slides):
    ...
    for shape in slide.shapes:
        if shape.has_text_frame:
            ...
            if 'PS26034' in t:
                print(f"  Slide 1: PS26034 ✓")
            if '57893' in t:
                print(f"  Slide 1: Team ID 57893 ✓")
            if 'Zillion' in t:
                print(f"  Slide 1: Zillion MindsSashakt ✓")
            if 'METROLOGYAI' in t and i == 1:
                print(f"  Slide 2: METROLOGYAI ✓")
                break
